...
namespace LoopLeader.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public ViewResult ProductInfo(Product formProduct)
        {
            ...
            else return View("ProductIndex");
        }


        public ViewResult ProductDelete(Product productToBeDeleted)
        {
            return View(productToBeDeleted);
        }

        public ActionResult ProductDeleteConfirmed(Product productToBeDeleted)
        {
            ProductRepository repo = new ProductRepository();
            repo.DeleteProduct(productToBeDeleted.ProductID);
            return View(productToBeDeleted);
        }
